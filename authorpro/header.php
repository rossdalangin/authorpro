...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'authorpro' ); ?></a>
        ...
        <div class="container">
            ...
            <div class="header-right-group">
                <nav id="site-navigation" class="main-navigation">
                    <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'authorpro' ); ?></button>
                    <?php
                    wp_nav_menu(
                        array(
                ...
                ?>
                <a href="<?php echo esc_url( $cta_url ); ?>" class="button mobile-cta-button"><?php echo esc_html( $cta_text ); ?></a>
                <?php endif; ?>
            </div><!-- .header-right-group -->
        </div><!-- .container -->
	</header><!-- #masthead -->
